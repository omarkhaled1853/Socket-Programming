...
def test_performance_with_n_client(n: int):
    start_time = time.time()

    for i in range(n):
        thread = threading.Thread(target=main, kwargs={"host": "localhost", "port": 8080})
        thread.start()
...
print(test_performance_with_n_client(300) * 1000)
